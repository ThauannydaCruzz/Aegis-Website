...
const teamMembers = [
  { 
    name: "Alecsandro Costa", 
    initials: "AC", 
    role: "Especialista em Segurança",
    description: "Especialista na coleta inteligente de dados voltados à segurança digital com precisão e confiabilidade.",
    linkedin: "https://linkedin.com/in/alecsandro",
    instagram: "https://instagram.com/alecsandro",
  ...
  { 
    ...
    initials: "AJR", 
    role: "Especialista em Segurança",
    description: "Atuação estratégica em segurança digital com ênfase em sistemas de reconhecimento facial.",
    linkedin: "https://linkedin.com/in/anajulia",
    instagram: "https://instagram.com/anajulia",
    whatsapp: "+5511999999999"
  },
  { 
    name: "Gabriela Akemi", 
    initials: "GA", 
    role: "UI/UX designer",
    description: "Atuação em UI/UX com ênfase em usabilidade e integração eficiente com APIs e serviços back-end.",
  ...
  { 
    name: "Nadine Castro", 
    initials: "NC", 
    role: "Pesquisadora de Sistemas Inteligentes",
    description: "Investigação sobre desempenho, usabilidade e evolução das funcionalidades em chatbots",
    linkedin: "https://linkedin.com/in/nadine",
    instagram: "https://instagram.com/nadine",
    whatsapp: "+5511999999999"
  },
  { 
    name: "Renan Hikaru", 
    ...
    role: "Especialista em Segurança",
    description: "Especialista na coleta inteligente de dados voltados à segurança digital com precisão e confiabilidade.",
    linkedin: "https://linkedin.com/in/renanhikaru",
    instagram: "https://instagram.com/renanhikaru",
    whatsapp: "+5511999999999"
  },
  { 
    name: "Sophia Mattos", 
    initials: "SM", 
    role: "Especialista em Segurança",
    description: "Especialista em soluções de segurança com tecnologia avançada de reconhecimento facial.",
  ...
  { 
    ...
    initials: "TC", 
    role: "Desenvolvedora",
    description: "Desenvolvedora Front-End especializada em interfaces modernas com React, CSS e Tailwind.",
    linkedin: "https://linkedin.com/in/thauanny",
    instagram: "https://instagram.com/thauanny",
    whatsapp: "+5511999999999"
  },
  { 
    name: "Vinicius Cristino", 
    initials: "VC", 
    role: "Especialista em Interação Homem-Máquina",
    description: "Pesquisa aplicada em recursos avançados de chatbots, com foco em personalização e eficiência na comunicação.",
    linkedin: "https://linkedin.com/in/vinicius",
    instagram: "https://instagram.com/vinicius",
    whatsapp: "+5511999999999"
  },
];
...
const AegisTeam = () => {
  ...
  const showTipToast = () => {
    toast({
      title: "Dica útil!",
      description: "Pratique segurança digital todos os dias para proteger seus dados.",
    });
  };
