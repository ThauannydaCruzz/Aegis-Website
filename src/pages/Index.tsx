  ...
  return (
    <div className="h-screen w-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="relative h-full w-full flex flex-col items-center justify-center px-6 z-10">
        ...
        Combinamos automação avançada, análise contínua de riscos e uma arquitetura robusta para garantir um ambiente seguro, adaptável e em constante evolução.
        Com o Aegis, você não apenas reage a ataques — você os prevê.
        </p>
