...
import { generateBotResponse, getSpecialContent } from '@/utils/chatUtils';
        ...
        <div className={`w-full space-y-4 transition-all duration-500 ${showOptions || messages.length > 0 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-white">Novos insights</span>
            </Button>
            ...
            >
              ...
              <span className="text-white">Dicas úteis</span>
            </Button>
          </div>
