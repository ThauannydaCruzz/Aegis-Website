    ...
    <div className="min-h-screen bg-gradient-to-br from-aegis-darker via-black to-aegis-dark">
      <div className="container mx-auto px-4 py-8">
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-2 text-white">Meu Dashboard</h1>
          ...
          <Card className="mb-8 bg-gradient-to-br from-emerald-400/20 to-emerald-600/5 border-emerald-500/20">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-white mb-1">Score de Segurança</h2>
                  <p className="text-emerald-400 text-sm">+12% desde o último mês</p>
                </div>
                <div className="text-5xl font-bold text-white">78<span className="text-2xl text-emerald-400">/100</span></div>
              </div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-2">
                <Button variant="outline" className="bg-black/10 border-emerald-500/20 text-white">Melhorar Score</Button>
                <Button variant="outline" className="bg-black/10 border-white/10 text-white">Ver Detalhes</Button>
                <Button variant="outline" className="bg-black/10 border-white/10 text-white">Compartilhar</Button>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Card className="bg-white/5 border-white/10">
              <CardHeader className="flex flex-row items-center justify-between p-4 pb-2">
                <CardTitle className="text-lg font-medium text-white">Contas Protegidas</CardTitle>
              ...
              <CardContent className="p-4">
                ...
                <Button variant="outline" className="w-full mt-4 border-white/10 bg-white/5 text-white">
                  Adicionar Conta
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/5 border-white/10">
              <CardHeader className="flex flex-row items-center justify-between p-4 pb-2">
                <CardTitle className="text-lg font-medium text-white">Análise de Vulnerabilidades</CardTitle>
                <PieChart className="h-5 w-5 text-aegis-teal" />
              </CardHeader>
              <CardContent className="p-4">
                <div className="relative">
                  {/* Simplified donut chart */}
                  <div className="w-48 h-48 mx-auto mb-4 rounded-full border-[16px] border-aegis-teal/80 relative">
            ...
            <Card className="bg-white/5 border-white/10">
              <CardHeader className="flex flex-row items-center justify-between p-4 pb-2">
                <CardTitle className="text-lg font-medium text-white">Incidentes de Segurança</CardTitle>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-center p-2 bg-black/20 rounded-lg">
                      ...
                      <span className="text-sm text-white">{incident.text}</span>
                    </div>
                  ))}
                </div>
                <Button variant="outline" className="w-full mt-4 border-white/10 bg-white/5 text-white">
            ...
            <Card className="bg-white/5 border-white/10">
              <CardHeader className="flex flex-row items-center justify-between p-4 pb-2">
                <CardTitle className="text-lg font-medium text-white">Atividade de Segurança</CardTitle>
          ...
          {/* Recommendations */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4 text-white">Recomendações de Segurança</h2>
              ...
              {[
                ...
                <Card key={index} className="bg-white/5 border-white/10">
                  <CardContent className="p-4">
                    ...
                    <Button variant="link" className="text-aegis-purple p-0 h-auto mt-2">Resolver agora</Button>
                  </CardContent>
                </Card>
              ))}
            </div>
