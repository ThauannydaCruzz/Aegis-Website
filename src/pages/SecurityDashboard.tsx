          ...
          <Card className="mb-8 bg-gradient-to-br from-emerald-400/20 to-emerald-600/5 border-emerald-500/20">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-black mb-1">Score de Segurança</h2>
                  <p className="text-emerald-400 text-sm">+12% desde o último mês</p>
                </div>
                <div className="text-5xl font-bold text-grey">78<span className="text-2xl text-emerald-400">/100</span></div>
              </div>
