...
const Welcome = () => {
  ...
  const fullText = "Olá! Sou o AegisBot! Estou aqui para garantir a segurança dos seus dados e proteger sua privacidade.";
  ...
  return (
    <div className="min-h-screen w-full bg-black flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md mx-auto text-center mb-10">
        ...
        <p className="text-xl text-white min-h-[6rem]">
          {typedText}
